...
| `DEVICE-001` | Запланирована | Постоянный UUID устройства и локальная конфигурация |
| `STORE-001` | Запланирована | SQLite, локальная история и offline queue |
| `COLLECT-001` | Запланирована | Процессы, CPU, диски, ОС, драйверы и системные события |
| `COLLECT-002` | Запланирована | GPU, VRAM и доступные температурные датчики |
| `COLLECT-003` | Запланирована | Сетевые счётчики, пакеты, соединения и качество связи |
